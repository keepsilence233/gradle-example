...
/**
 * Precompiled qx.leizige.gradle.example.java-application-conventions script plugin.
 **/
public class QxLeizigeGradleExampleJavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_QxLeizigeGradleExampleJavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("qx.leizige.gradle.example.java-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_QxLeizigeGradleExampleJavaApplicationConventions").asSubclass(BasicScript.class);
